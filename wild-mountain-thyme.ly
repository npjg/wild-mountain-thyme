...
soprano = \relative c'' {
  ...
  d8 f8~ f2~ | f2.~ | f2. | r4 f4 d | c2 a8 c8 | d8 f4 g4~ g8 | f2. \bar "||"
  r4 a4 c4 | d4~ d8 e d c | a8 c8~ c2 | R2. | r2 f,8 g8 |
  aes4~ aes8 g8 f4  | aes bes c | bes2. | r4 g4 a?4 \bar "||" bes2. | bes2 a4 | 
  a8 f8~ f2~ | f4 d4 f4 | g2. | g2 a4 | f8 d8~ d2 | r4 a f' | g2. | 
...
alto = \relative c' {
  ...
  << { d8 f~ f4 c4~ | c2. |  } \\ { d8 f~ f4 c8 bes8 | c2. | } >>
  des2. | ees2. | r4 g4 a?4 \bar "||" bes4 a4 g4 | g2 g4 | 
  f8 d8~ d2~ | d4 d4 d4 | ees2. | ees4 f4 ees4 | f8 d8~ d4 c4 | d4 a8 bes8 c4 | ees4 d2 | 
  ees4 d4 ees4 | d2.
...
tenor = \relative c' {
  ...
  << { r4 f d | c4 f4 f4 | f2 g4 | a8 a8~ a2 |
       ...
       f4 g4 a4 | bes2 a4 | g4~ g8 a g f | d8 f8~ f2 \breathe |
       R2. | R2. | g'8 f8~ f2~ | f2. | f2. | R2. 
       r4 d4 f | f2. | f8 f8~ f2~ |
       \slurDashed f4( a4) f4 | f2. | e2 c4 | bes8 a8~ a2 |
       r2 a4 | d2. | d2 bes4 | f8 f8~ f2 | d8 f8~ f2 | R2. 
     } \\
     { r4 f d | c4 f4 f4 | f2 e4 | f8 f8~ f2 |
       r4 a c | d2 c4 | d2 c4 | a4 c2 |
       r4 a4 a4 | a2 a4 | c2~ c8 a8 | g2 a8 g8 | 
       f4 g4 a4 | g2 f4 | ees2 f4 | d8 f8 ~f2 |
       R2. | R2. | des'8 des8~ des2~ | des2. | d2. | R2.
       r4 d4 f | e d~ d8 c-- | a8 c8~ c2~ | 
       \slurDashed c4( a'4) f4 | f2. | e2 c4 | bes8 a8~ a2 |
       r2 a4 | bes4 c d | d2 bes4 | f8 f8~ f2 | d8 f8~ f2~ | f2. 
     } 
  >> 
  r4 f'4 d | c2 a8 c8 | d8 f4 g4~ g8 | f2. | 
  R2. | R2. | r2 a,4 | g4~ g8 a g f | d f~ f4 f8 g16 aes16~ | aes2. |
  aes4 bes c | bes2. | r4 g4 a?4 | bes4 c4 d4 | d2 d8 c8  | 
  d8 a8~ a4 g4 | a4 d4 f4 | bes,2. | bes2 c4 | bes8 bes8~ bes2 | r4 a a | bes2. | 
...
bass = \relative c {
  ...
  bes2. | a2~ a8 a8 | bes8 d~ d2 |
  d2.~ | d2.~ | d2. | bes8 d8~ d2 
  \breathe r4 f d4 | c2 a4 |  bes8 d8~ d2 |
  d2~ d8 e8 | f2. 
  
  << { r4 f d | c f e | d2 c4 | f8 f8~ f2 | 
       r4 a4 a4 | a2 a4 | a2 a4 | e4 a2 | 
       r4 a4 g4 | f2 f4 | e4~ e2 | g2. |
       f4 g4 a4 | ees2. | ees2. | bes8 d8~ d2 \breathe | 
       r4 f d | des8 f8~ f2 | bes8 bes8~ bes2~ | bes2. | a2. | R2.
     } \\ 
     { r4 f d | c f e | d2 c4 | c2 e4 | 
       d4 r4 e8 g8 | f2 e4 | f2 e4 | c4 e4 f4 |
       g4 a4 e4 | f2 e4 | c4 a2 | bes2. | 
       d4 g4 a4 | bes,2. | bes2. | bes8 d8~ d2 | 
       r4 \mark \markup { \italic { sotto voce } } f d | des8 f8~ f2~ | f2 g4 | a4 g4 f4 | f2. | R2. 
     } 
  >> \bar "||"
  ...
  r4 f'4 d | c2 a8 c8 | d8 f4 g4~ g8 |  f2. |
  r4 a4 c4 | d4~ d8 e d c | a8 c8~ c2 | R2. | r2 f,8 ees | des4~ des8 ees8 f4 | 
  f2~ f8 aes8~ | aes2 g4 | r4 g4 a?4 | bes2. | bes2 bes8 a8 | 
...
sopranoVerse = \lyricmode {
  ...
  Will you go, O las __ _ _ -- sie? Will you go, O? __
...
bassVerse = \lyricmode {
  ...
  I will make _ my love a bow -- er __ _ _ _
